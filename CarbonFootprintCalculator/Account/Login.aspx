...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    <style>
        /* Define custom styles for the login form */
        main {
            padding: 20px;
        ...
        .checkbox label {
            color: #6c757d; /* Gray color for checkbox label */
        }
        .btn-login {
                ...
                <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-offset-2 col-md-10">
                            <asp:Button runat="server" OnClick="LogIn" Text="Log in" CssClass="btn btn-login" />
                        </div>
                    </div>
                </div>
                <p>
